...
REM There is a different counter for null tasks that are inserted to provide comments in the task list.
REM These numbers do not form part of the line in the menu, but they are required in the dex command.
set comment=0
...
REM Show approximate *Time Remaining.
set /A "comment=comment+1"
echo CMD_TASK,%comment%,null_task.dex, *Time Remaining ~24 min
...
REM Show approximate *Time Remaining.
set /A "comment=comment+1"
echo CMD_TASK,%comment%,null_task.dex, *Time Remaining ~21 min
...
REM Show approximate *Time Remaining.
set /A "comment=comment+1"
echo CMD_TASK,%comment%,null_task.dex, *Time Remaining ~16 min
...
REM Show approximate *Time Remaining.
set /A "comment=comment+1"
echo CMD_TASK,%comment%,null_task.dex, *Time Remaining ~11 min
...
REM Show approximate *Time Remaining.
set /A "comment=comment+1"
echo CMD_TASK,%comment%,null_task.dex, *Time Remaining ~6 min
...
REM Show approximate *Time Remaining.
set /A "comment=comment+1"
echo CMD_TASK,%comment%,null_task.dex, *Time Remaining ~1 min

...
set params=-targeted -%mass% -%posture% -%direction% -tag=%tag% -targets=TargetedTargets%direction%30.txt:6%sz%  
...
%COMPILER% -discrete -%mass% -%posture% -%direction% -%eyes% -range=%range% -delays=DiscreteDelaySequences20.txt:7 -tag=%tag% -compile=%filename%
...
REM Put all the paramters together for the compiler.
set params=-collisions -%mass% -%posture% -tag=%tag% -delays=CollisionsSequences30.txt:%sq%
